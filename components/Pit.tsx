...
const Stone: React.FC<{ index: number }> = ({ index }) => {
  ...
  return <div className={`absolute w-1.5 h-1.5 sm:w-2 sm:h-2 md:w-2.5 md:h-2.5 lg:w-3 lg:h-3 rounded-full ${color} border border-stone-900/70 ${position} stone-hover-effect`} />;
};
