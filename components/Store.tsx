...
const Store: React.FC<StoreProps> = ({ stones, player, isActive }) => {
  ...
  const storeClasses = [
    'store-frame pixel-shadow relative w-24 h-56 md:w-28 md:h-72 rounded-2xl border-4',
    borderColor,
    baseBg,
  ...
  return (
    <div className={storeClasses}>
      ...
      <span className="relative text-5xl text-amber-100 font-bold drop-shadow-[2px_2px_0_rgba(0,0,0,0.75)]">
        {stones}
      </span>
    </div>
  );
